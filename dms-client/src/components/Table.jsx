  ...
  return (
    <>
            ...
            {data.length === 0 ? (
              ...
              data.map((doc, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <div>
                      <div className="font-bold">{doc.documentName}</div>
                    ...
                    <div className="flex items-start gap-1">
                      ...
                      <div>
                        <div className="font-bold">
                          {doc.uploaderName.length > 12
                            ? `${doc.uploaderName.slice(0, 12)}...`
                            : doc.uploaderName}
                        </div>
                        <div className="text-xs opacity-50">HR Department</div>
                      </div>
                    </div>
                  </td>
                  <td>
      ...
      {isModalOpen && selectedDocument && (
        <dialog id="document_attachment" className="modal">
